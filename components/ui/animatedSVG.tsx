...
const AnimatedSVG = () => {
  ...
  useEffect(() => {
    const cycleGradient = async () => {
      // Animate each stop with a delay between animations
      ...
      // Reverse animation to smoothly transition back to initial state
      await controls.start({
        offset: 0.25,
        transition: { duration: 3, ease: "linear" },
      })
      ...
      // Introduce a delay using setTimeout to allow the event loop to continue
      setTimeout(cycleGradient, 0)
    }
      ...
      >
        <defs>
          <linearGradient id="gradient">
            ...
            <motion.stop offset={0.5} stopColor="#49393b" animate={controls} />
