        ...
        <div className="flex h-full w-full flex-col gap-8">
          <div className="flex flex-col-reverse items-center justify-around gap-4 md:flex-row">
            ...
            <Link
              ...
              target="_blank"
              className={
                "flex max-w-[250px] flex-row flex-nowrap items-center gap-2 rounded border border-popover-foreground bg-primary px-4 py-2 font-bold text-white hover:bg-green-900 dark:border-yellow-600 dark:bg-btnbg dark:text-[#693434] dark:hover:bg-yellow-600"
              }
            >
              <Image
                src="/instagram.svg"
            ...
            <Link
              ...
              target="_blank"
              className={
                "flex max-w-[200px] flex-row flex-nowrap items-center gap-2 rounded border border-popover-foreground bg-primary px-4 py-2 font-bold text-white hover:bg-green-900 dark:border-yellow-600 dark:bg-btnbg dark:text-[#693434] dark:hover:bg-yellow-600"
              }
            >
              <Image
                priority={true}
